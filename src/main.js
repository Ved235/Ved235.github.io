const COMMANDS = {
    help: 'Supported commands: ["<span class="code">about</span>", "<span class="code">blog</span>", "<span class="code">education</span>", "<span class="code">skills</span>", "<span class="code">contact</span>","<span class="code">party</span>"]',
    about:
    ...
    skills: '<span class="code">Languages:</span> HTML, CSS, JavaScript, Python and C<br><span class="code">Technologies:</span> Git, Node.js and Firebase<br><span class="code">Frameworks:</span> React.js and Phaser.js',
    
    education: "I am a Grade 8th student at Scottish High International School, Gurgaon. <br> I have done several bootcamps as well.",
    
    blog: "Happy Reading",
    
    contact:'You can contact me on any of the following links:<br>["<a target="_blank" rel="noopener noreferrer" href="https://github.com/Ved235" class="social link">GitHub</a>"]',
